...
//    }
//
//    implicit object Dimension extends Type[java.awt.Dimension] {
...
//  }
//
//  def user  (clazz: Class[_]): Foo = ???
//  def system(clazz: Class[_]): Foo = ???
//
//  type Listener[A] = Option[A] => Unit
//
//  final case class Entry[A](prefs: Foo, key: String)(implicit tpe: Type[A]) {
...
//
//  def apply[A: Type](key: String): Foo.Entry[A]
//}
//
//object FooBug {
//  def test(p: Foo) {
